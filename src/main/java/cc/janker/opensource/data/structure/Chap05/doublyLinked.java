...
class DoublyLinkedList
{
    ...
    {
        Link5 newLink = new Link5(dd);   // make new link
    ...
    // -------------------------------------------------------------
    public Link5 deleteFirst()         // delete first link
    ...
    // -------------------------------------------------------------
    public Link5 deleteLast()          // delete last link
    {                              // (assumes non-empty list)
        Link5 temp = last;
        if(first.next == null)         // if only one item
    ...
    {                              // (assumes non-empty list)
        Link5 current = first;          // start at beginning
    ...
    // -------------------------------------------------------------
    public Link5 deleteKey(long key)   // delete item w/ given key
    {                              // (assumes non-empty list)
        Link5 current = first;          // start at beginning
        while(current.dData != key)    // until match is found,
        {
    ...
    public void displayBackward()
    {
        ...
        Link5 current = last;           // start at end
