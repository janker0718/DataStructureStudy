package cc.janker.opensource.data.structure.Chap11;// hashChain.java
...
// -------------------------------------------------------------
   public Link7(int it)                 // constructor
      { iData= it; }
// -------------------------------------------------------------
   public int getKey()
      { return iData; }
...
class SortedList
   {
   private Link7 first;               // ref to first list item
// -------------------------------------------------------------
   public void SortedList()          // constructor
      { first = null; }
// -------------------------------------------------------------
   public void insert(Link7 theLink)  // insert link, in order
      {
...
// -------------------------------------------------------------
   public Link7 find(int key)         // find link
      {
         Link7 current = first;          // start at first
                                     // until end of list,
...
// -------------------------------------------------------------
   public void displayList()
      ...
      System.out.print("List (first-->last): ");
         Link7 current = first;       // start at beginning of list
...
// -------------------------------------------------------------
   public void insert(Link7 theLink)  // insert a link
      {
      int key = theLink.getKey();
...
// -------------------------------------------------------------
   public Link7 find(int key)         // find link
      {
      int hashVal = hashFunc(key);   // hash the key
         Link7 theLink = hashArray[hashVal].find(key);  // get link
