package cc.janker.opensource.data.structure.Chap04;// postfix.java
...
class StackXXXX
   ...
   private int top;
//--------------------------------------------------------------
   public StackXXXX(int size)      // constructor
      {
      maxSize = size;
...
//--------------------------------------------------------------
   public int doParse()
      {
      theStack = new StackXXXX(20);             // make new stack
      char ch;
      int j;
